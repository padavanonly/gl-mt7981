...
struct wed_rx_ctrl {
	...
	spinlock_t recy_lock;
#endif
	u8 extend_polling_cnt;
};
...
enum {
	...
	WED_HW_CAP_PASSIVE_INT = BIT(8),
	WED_HW_CAP_RRO_DBG_MODE = BIT(9),
	WED_HW_CAP_RRO_DBG_MEMCPY_MODE = BIT(10),
};
